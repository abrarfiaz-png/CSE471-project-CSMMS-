...
class Service(Base):
    ...
    blocked_dates = relationship("BlockedDate", back_populates="service", cascade="all, delete-orphan")
...
class BlockedDate(Base):
    ...
    reason = Column(String(500), nullable=True)  # e.g., "Personal leave", "Maintenance"
    created_at = Column(DateTime(timezone=True), server_default=func.now())
